(function(testCase){
  ...
  console.debug('Testing JavaScript Array with 1000 Float elements');
  console.debug('*************************************************');

  var data_01 = d3.range(0, 1000).map(Math.random);
  var data_02 = d3.range(500, 1000).map(Math.random);
  var data_03 = d3.range(10, 100).map(Math.random);
